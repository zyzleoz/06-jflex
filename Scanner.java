...
class Scanner {
   ...
   * @exception   java.io.IOException  if any I/O-Error occurs
   */
  public int getLexema() throws java.io.IOException {
    int zzInput;
    int zzAction;
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 4: break;
          case 2: 
            { System.out.println(" -> Encontrei um <Token: IDENTIFICADOR, Lexema: " + getLexema() + ", Tamanho: " + yylength() + ", Linha: " + yyline + ", Coluna: " + yycolumn + ">");
            } 
            // fall through
          case 5: break;
          case 3: 
            { System.out.println(" -> Encontrei um <Token: DIGITO, Lexema: "        + getLexema() + ", Tamanho: " + yylength() + ", Linha: " + yyline + ", Coluna: " + yycolumn + ">");
            } 
            // fall through
          case 6: break;
          default:
    ...
    if (argv.length == 0) {
      ...
      for (int i = firstFilePos; i < argv.length; i++) {
        ...
        try {
          ...
          while ( !scanner.zzAtEOF ) scanner.getLexema();
        }
